    ...
    <div class="left-container" id="leftContainer">
      ...
      <div class="left-top-container" :style="leftTopOpacityStyle">
        <div class="left-top" :style="leftTopOpacityStyle">
          ...
          <div class="avatarCard" v-for="item in userList" :index="item.name" :key="item.name">
            <div class="avatarBox">
              <img src="../assets/img/liveAvatar.png" alt />
            </div>
      ...
      <div class="left-bottom" :style="'opacity:'+leftBottomOpacity+'%;'">
        ...
        <div class="commentOption">
          <el-switch v-model="anonymousOption" active-text="匿名" inactive-text style="margin-bottom:2px;"></el-switch>
              ...
              <el-tab-pane label="小功能" name="miniprogram">
                <div class="quiz-box" :style="rightContentHeight">
                  ...
                  <el-card style="margin-bottom:10px">
                    ...
                    <div class="question-text">A change in the coding region of a gene can lead to a new allele for that gene. Which property of the protein, coded for by this new allele, could be changed as a result?</div>
                  ...
                  <el-card>
                    ...
                    <div class="question-text">What type of amino acids would you expect to see in such proteins? Why?</div>
                    <el-input
                      type="textarea"
                      :rows="3"
                      placeholder="请输入您的回答"
...
export default {
  ...
  watch: {
    fullHeight (val) {
      if (!this.timer) {
        this.fullHeight = val
        const rightContainer = document.getElementById('righttContainer')
        this.rightContentHeight =
          'height:' + (rightContainer.offsetHeight - 126) + 'px'
        this.rightPDFHeight =
